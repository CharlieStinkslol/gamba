...
const Plinko = () => {
  ...
  useEffect(() => {
    const savedSettings = JSON.parse(localStorage.getItem('charlies-odds-plinko-current-settings') || '{}');
  ...
  const saveSettings = () => {
    ...
    localStorage.setItem('charlies-odds-plinko-current-settings', JSON.stringify(settings));
  };
